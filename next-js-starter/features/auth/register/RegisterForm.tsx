...
import { Box, Button, Group, LoadingOverlay, Paper, PasswordInput, TextInput } from '@mantine/core';
  ...
  return (
    <Paper withBorder shadow="md" p={30} mt={30} radius="md" pos="relative">
      ...
      <Form action={action}>
        ...
        <Button disabled={pending} type="submit" fullWidth mb="xl" data-testid="register-submit">
          Register
        </Button>
      </Form>
